...
from darknet_test.srv import YOLOLastFrame, YOLOLastFrameResponse
from darknet_test.msg import YOLODetection
import numpy as np
...
class YOLOv4ROSITR:
    def __init__(self):
        self.detector = Detector(gpu_id=0, config_path='/opt/darknet/cfg/yolov4.cfg',
                                 ...
                                 meta_path='/home/jason/tiago_public_ws/src/jason_pkgs/darknet_test/config/coco.data')

        self.bridge = CvBridge()
        self.cam_subs = rospy.Subscriber("/usb_cam/image_raw", Image, self.img_callback)
        #self.cam_subs = rospy.Subscriber("/xtion/rgb/image_raw", Image, self.img_callback)
